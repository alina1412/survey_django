...
urlpatterns = [
    ...
    path('survey-detail/<int:survey_id>/',
         views.DetailSurveyView.as_view(), name='survey_detail'),
    path('surveys/', views.OwnedListSurveysView.as_view(), name='survey_list'),

    path('add-question/<int:survey_id>/',
         views.AddQuestionView.as_view(), name='add_question'),
    path('question-detail/<int:question_id>/',
         views.DetailQuestionView.as_view(), name="question_detail"),
    ...
    path('add-choice/<int:question_id>/',
         views.AddChoiceView.as_view(), name='add_choice'),
